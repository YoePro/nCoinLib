...
namespace nCoinLib.Util.Types
{
    ...
    // TODO: Fix this UInt256
    public class UInt256
    {
        public class MutableUInt256 : ICoinSerializable
        {
            UInt256 _Value;
        ...
        public UInt256(byte[] vch, bool lendian = true)
        {
            ...
            pn5 = nConvert.ToUInt32(vch, 4 * 5, true);
            pn6 = nConvert.ToUInt32(vch, 4 * 6, true);
            pn7 = nConvert.ToUInt32(vch, 4 * 7, true);
        ...
        public UInt256(string str)
        {
            ...
            pn5 = nConvert.ToUInt32(bytes, 4 * 5, true);
            pn6 = nConvert.ToUInt32(bytes, 4 * 6, true);
            pn7 = nConvert.ToUInt32(bytes, 4 * 7, true);
        ...
        public byte[] ToBytes(bool lendian = true)
        {
            ...
            Buffer.BlockCopy(nConvert.ToBytes(pn5, true), 0, arr, 4 * 5, 4);
            Buffer.BlockCopy(nConvert.ToBytes(pn6, true), 0, arr, 4 * 6, 4);
            Buffer.BlockCopy(nConvert.ToBytes(pn7, true), 0, arr, 4 * 7, 4);
            if (!lendian)
                Array.Reverse(arr);
            return arr;
        }
